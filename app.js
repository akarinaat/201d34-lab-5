...
function sumAndMultiply(a, b, c) {
  var sumNumber = sum(sum(a,b)[0], c)[0];
  var productNumber = multiply(multiply(a,b)[0],c)[0];
  return [sumNumber, productNumber, a + ' and ' + b + ' and ' + c + ' sum to ' + sumNumber + '.', 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + productNumber + '.'];  //eslint-disable-line
}
...
function multiplyArray(multArr) { //eslint-disable-line
  var fifthArray = multiply(multiply(multArr[0],multArr[1])[0],multArr[2])[0];
  return [fifthArray,'The numbers ' + multArr.join(',') + ' have a product of ' + fifthArray + '.'];
